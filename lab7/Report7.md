...
Если длина введенной строки меньше 5 знаков, то вводим переменную \, обозначающую начало строки, и делаем персонализированный вывод для каждой такой короткой строки.  
Если длина строки >= 5 знаков, то выполняется следующий алгоритм:  
...
| 100               | -3              | Восстановление отрицательного числа в 16-ной системе счисления по его доп. коду, длина которого < 5 знаков       |   
| 0111              | 7               | Восстановление отрицательного числа в 16-ной системе счисления по его доп. коду, длина которого < 5 знаков       |   
