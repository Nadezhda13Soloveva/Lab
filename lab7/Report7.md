...
Если длина введенной строки меньше 5 знаков, то вводим переменную \, обозначающую начало строки, и делаем ерсонализированный вывод для каждой такой короткой строки.  
